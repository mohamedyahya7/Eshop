    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <header class="py-4 shadow-sm bg-white">
        <div class="container flex items-center justify-between">
          <a href="{{ route('home') }}"><img src="{{ asset('logo.png') }}" alt="Logo" class="w-24 h-16" /></a>
          <div class="w-full max-w-xl relative flex">
            ...
            <button
              class="bg-primary justify-center items-center border border-primary text-white px-8 rounded-r-md hover:bg-transparent hover:text-primary transition md:flex hidden">
              Search</button>
          </div>
        ...
        <div class="container flex">
          ...
          <div class="flex items-center justify-between flex-grow md:pl-12 py-5">
            <div class="flex items-center space-x-6 capitalize">
              ...
              <a href="{{ route('categories') }}" class="text-gray-200 hover:text-white transition">Categories</a>
              <a href="{{ route('cart') }}" class="text-gray-200 hover:text-white transition">Cart</a>
